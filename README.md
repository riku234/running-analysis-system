...
- **角度推移分析**: 骨格認識された期間の関節角度を時系列グラフで可視化 ⭐NEW
...
### v1.1.0 (2025年11月2日)
- ✨ **新機能**: 角度推移分析グラフで骨格認識期間のみを表示
  - グラフのX軸が有効データ範囲に自動調整
  - null値（骨格認識失敗）を除外して視認性を向上
  - 詳細: [ANGLE_GRAPH_IMPROVEMENT_REPORT.md](./ANGLE_GRAPH_IMPROVEMENT_REPORT.md)

### v1.0.0 (2025年1月26日)
- 🎉 初回リリース
- 動画アップロード、骨格検出、特徴量解析、改善アドバイス機能実装
